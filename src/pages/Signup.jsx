      ...
      <div className="w-full h-screen ">
        ...
        <div className="fixed w-full h-screen top-0 right-0 bottom-0 left-0 z-20 ">
          <div className="md:w-[450px] h-[600px] mx-auto my-16 rounded bg-black/75 text-white">
            <div className="w-full md:w-[320px] mx-auto px-8 md:px-[0] py-16 ">
              ...
              <form onSubmit={handleSignUp} className="mt-8">
                ...
                <button className="mt-[46px] mb-[12px] w-full bg-[#e50914] text-white rounded p-[12px] cursor-pointer font-bold">
                  Sign up
                </button>
                ...
                <p className="py-8">
                  ...
                  <Link className="text-md ml-2 hover:underline" to="/login">
                    Sign In
                  </Link>
                </p>
              </form>
